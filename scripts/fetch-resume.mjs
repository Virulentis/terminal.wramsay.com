...
const RESUME_PDF_PATH = process.env.VITE_RESUME_PDF_PATH || 'William_Ramsay_CV.pdf';
...
const RESUME_FILE_NAME = process.env.RESUME_FILE_NAME;

// Paths
const publicDir = path.join(__dirname, '..', 'public');
const localYamlPath = path.join(__dirname, '..', 'William_Ramsay_CV.yaml');
const localPdfPath = path.join(__dirname, '..', 'William_Ramsay_CV.pdf');
const targetYamlPath = path.join(publicDir, 'William_Ramsay_CV.yaml');
const targetPdfPath = path.join(publicDir, 'William_Ramsay_CV.pdf');
